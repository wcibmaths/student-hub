...
import { SPECIFICATIONS } from '../data/documents';
import { TopicLink } from '../components/PillPair';

interface Props { onNav: (v: View) => void; }

export function Specifications({ onNav }: Props) {
  return (
    <div className="view-enter" style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
      <div className="pg-header">
        ...
        <div className="pg-title-row">
          <div className="pg-title">Specifications</div>
      ...
      <div className="pg-body">
        <div className="note-bar">
          ...
          Official Edexcel specification documents for each programme.
        </div>
